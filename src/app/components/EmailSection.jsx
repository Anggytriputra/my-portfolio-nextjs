    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/Anggytriputra">
            <Image
              src={GithubIcon}
              alt="Github Icon"
            />
          </Link>
          <Link href="https://www.linkedin.com/in/anggytriputra27/">
            <Image
              src={LinkedinIcon}
              alt="Linkdiin Icon"
            />
      ...
      <div>
        ...
        >
          {/* Render form elements only if email is not submitted */}
          {!emailSubmited && (
            <>
              <div className="mb-6">
                <label
          ...
          {/* Render success message if email is submitted */}
          {emailSubmited && (
